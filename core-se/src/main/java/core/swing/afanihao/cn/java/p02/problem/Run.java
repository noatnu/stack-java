package core.swing.afanihao.cn.java.p02.problem;
...
public class Run extends RunAbs {
    ...
    public void testRun() {
        ...
        Consumer<String> consumer = new Consumer<String>() {
            ...
            public void accept(String s) {
                ...
                //向内容面板里面添加控件
                containerPanel.add(new Label("Hello world!"));
                containerPanel.add(new Button("测试按钮"));
