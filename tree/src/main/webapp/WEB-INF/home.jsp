...
<div class="container">
    <div class="row">
        <div class="col-xs-offset-2 col-md-offset-2 col-xl-offset-2 col-sm-offset-2 col-xl-8 col-sm-8 col-lg-8 col-md-8" style="margin-top:10px;margin-bottom:10px;">
