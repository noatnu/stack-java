...
<script>
    ...
    objTree.selector = "#tree" ;

    objTree.getServerData = function (callback) {
        $.ajax({
            url: "${pageContext.request.contextPath}/treeNode/treeviewData",
            type: "get",
            dataType: "json",
            data: {},
    ...
    objTree.query = function () {

    };

    objTree.loadInit = function () {
        objTree.getServerData(function (data) {
            $tree = $('#tree').treeview(
                {
                data: data, //列表树上显示的数据
                levels: 5,
                ...
                selectedIcon: "glyphicon glyphicon-stop", //设置所有被选择的节点上的默认图标
    ...
    objTree.getSelect = function () {
        // var data = $(objTree.selector).treeview('getSelected');
