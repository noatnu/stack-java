...
import com.blue.common.PinYinUtil;
import com.blue.entity.*;
...
public class BiologyBeanPoUtils {
    ...
    public List<NodeExample> nodeExampleList() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            nodeExample.setId(RandomStringUtils.randomNumeric(12));
            nodeExample.setText(RandomStringUtils.random(11));
            for (int j = 10; j < 100; j++) {
                NodeExample nodeExample1 = new NodeExample();
                nodeExample1.setText(RandomStringUtils.random(8));
                nodeExample1.setId(RandomStringUtils.randomNumeric(7));
    ...
    public List<SimpleBean> simpleBeanList() {
        ...
        for (int i = 1; i < num; i++) {
            ...
            simpleBean.setPid(0);
            simpleBean.setId(i);
            simpleBean.setName(RandomStringUtils.random(6));
    ...
    public List<BiologyBeanPo> prototypeObj() {
        ...
        int m = 0;
        biologyBeanPoList.add(new BiologyBeanPo().setPid(0).setId(1).setTitle(map.get("a1")).setDate(new Date()).setName("水生生物").setOpen(true).setNumber(String.format("%d", m++)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
        biologyBeanPoList.add(new BiologyBeanPo().setPid(0).setId(2).setTitle(map.get("a2")).setDate(new Date()).setName("陆地生物").setOpen(true).setNumber(String.format("%d", m++)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
        biologyBeanPoList.add(new BiologyBeanPo().setPid(0).setId(3).setTitle(map.get("a3")).setDate(new Date()).setName("飞翔生物").setNumber(String.format("%d", m++)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
        biologyBeanPoList.add(new BiologyBeanPo().setPid(0).setId(4).setTitle(map.get("a4")).setDate(new Date()).setName("两栖生物").setOpen(true).setNumber(String.format("%d", m++)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
        final int num = 10;
        final int v = 4;
        for (int j = 1; j <= v; j++) {
            for (int i = 1; i < num; i++) {
                    ...
                    if (StringUtils.isNumeric(a)) {
                        if (i == 1) {
                            ...
                            if (a.equals("1")) {
                                ...
                                int temp = RandomUtils.nextInt(2, 10);
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("姥鲨").setTitle("姥鲨").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("斗鲨鱼").setTitle("斗鲨鱼").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("巨齿鲨").setTitle("巨齿鲨").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("哥布林鲨").setTitle("哥布林鲨").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("雪茄达摩鲨").setTitle("雪茄达摩鲨").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("皱鳃鲨").setTitle("皱鳃鲨").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("长尾鲨").setTitle("长尾鲨").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("巨口鲨").setTitle("巨口鲨").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                            }
                            if (a.equals("2")) {
                        ...
                        if (i == 2) {
                            ...
                            if (a.equals("1")) {
                                ...
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("蓝鲸").setTitle("蓝鲸").setDate(new Date()).setId(RandomUtils.nextInt(1000, 2000)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("虎鲸").setTitle("虎鲸").setDate(new Date()).setId(RandomUtils.nextInt(1001, 2001)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("逆戟鲸").setTitle("逆戟鲸").setDate(new Date()).setId(RandomUtils.nextInt(1002, 2002)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("角鲸").setTitle("角鲸").setDate(new Date()).setId(RandomUtils.nextInt(1004, 2004)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("白鲸").setTitle("白鲸").setDate(new Date()).setId(RandomUtils.nextInt(1004, 2004)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                            }
                            if (a.equals("2")) {
                        ...
                        if (i == 3) {
                            ...
                            if (a.equals("2")) {
                                ...
                                int temp = RandomUtils.nextInt(2, 10);
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("东北虎").setTitle("东北虎").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("华南虎").setTitle("华南虎").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("巴厘虎").setTitle("巴厘虎").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("印度支那虎").setTitle("印度支那虎").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("马来虎").setTitle("马来虎").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("爪哇虎").setTitle("爪哇虎").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("苏门答腊虎").setTitle("苏门答腊虎").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("孟加拉虎").setTitle("孟加拉虎").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                                biologyBeanPoList.add(new BiologyBeanPo().set_parentId(biologyBeanPo.getId()).setPid(biologyBeanPo.getId()).setName("里海虎").setTitle("里海虎").setDate(new Date()).setId(RandomUtils.nextInt(1000 + ++temp, 2000 + ++temp)).setArea(RandomUtils.nextDouble(1.0, 150.0)));
                            }
                            if (a.equals("3")) {
                        ...
                        if (i == 4) {
                            biologyBeanPo = new BiologyBeanPo();
                            biologyBeanPo.set_parentId(Integer.parseInt(a)).setPid(Integer.parseInt(a)).setId(n).setDate(new Date()).setOpen(false).setArea(RandomUtils.nextDouble(1.0, 150.0));
                            if (a.equals("1")) {
